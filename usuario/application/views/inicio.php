...
<div class=" overflow-hidden bg-menu height-100 cont-menu">
	<div class="row">
		<div class="col-12 p-t-20 text-right p-r-40" onclick="help.menu_close()">
			...
			<ul class="list-group">
			  <a href="<?= base_url('/inicio') ?>"><li class="list-group-item active"><i class="fa fa-cutlery" aria-hidden="true"></i> Inicio</li></a>
	...
	<div class="row">
		<div class="col-12 bg-menu p-t-10 p-b-10 ">
			<div class="row">
				...
				<div class="col-11">
					<span>Comanda Express | Inicio</span>
				</div>
			</div>
		</div>
		<div class="col-12 text-center text-Lobster titulo-pricipal">
						"Antojitos Columba"
		</div>
