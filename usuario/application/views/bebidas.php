	...
	<div class="row">
		<div class="col-12 p-t-20 text-right p-r-40" onclick="help.menu_close()">
			...
			<ul class="list-group">
			  ...
			  <a href="<?= base_url('/bebidas/0') ?>"> <li class="list-group-item active"><i class="fa fa-beer" aria-hidden="true"></i> Bebidas</li></a>
	...
	<div class="row">
		<div class="col-12 bg-menu p-t-10 p-b-10 ">
			<div class="row">
				...
				<div class="col-11">
					<span>Comanda Express | Bebidas</span>
				</div>
			</div>
		</div>
	</div>
			...
			<div class="container-fluid overflow-auto  position-absolute">
				<div class="row">
					...
					<div class="btn-group col-12" role="group" aria-label="Basic example">
					  <a href="<?= base_url('/bebidas/1')?>" type="button" class="btn btn-success mr-3">Refrescos</a>
					  <a href="<?= base_url('/bebidas/2')?>" type="button" class="btn btn-success mr-3">Jugos</a>
					  <a href="<?= base_url('/bebidas/3')?>"  type="button" class="btn btn-success mr-3">Licuados</a>
					  <a href="<?= base_url('/bebidas/4')?>"  type="button" class="btn btn-success">Café</a>
					</div>

					<?
					foreach ($bebidas as $platos) {
						?>
